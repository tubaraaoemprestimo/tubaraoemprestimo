...
const OFFERS = [
  {
    ...
    url:         'https://link.infinitepay.io/tubaraoemprestimo/VC1DLUEtSQ-ope8lFBEf-450,00',
    highlight:   true,
  ...
  },
  {
    ...
    desc:        'Aprenda a captar clientes com restrições e cobrar assessoria de regularização.',
    price:       'R$ 297',
    priceNote:   null,
  ...
  },
  {
    ...
    badge:       null,
    title:       'Módulo Moto',
    desc:        'Libere crédito com garantia de veículo — ticket médio 3× maior.',
    price:       'R$ 297',
    priceNote:   null,
    ...
    <section className="flex flex-col items-center gap-10 py-12 px-4 animate-in fade-in zoom-in-95 duration-700">
      ...
      <div className="text-center max-w-3xl">
        ...
        <p className="text-lg text-zinc-400 leading-relaxed">
          Clientes com restrições e garantia de veículo são os mais lucrativos.
        ...
        {OFFERS.map((offer) => (
          <div
            ...
            className={`relative flex flex-col bg-zinc-900 rounded-2xl p-6 border transition-all ${
              offer.highlight ? 'border-[#D4AF37] shadow-lg shadow-[#D4AF37]/10' : 'border-zinc-800'
            }`}
          >
            {offer.badge && (
