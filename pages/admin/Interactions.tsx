                ...
                <tr>
                  <td colSpan={5} className="p-12 text-center text-zinc-500">
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <p className="text-xs text-zinc-600">As conversas com o Chatbot aparecerão aqui.</p>
                    </div>
                  </td>
                </tr>
              ) : (
                logs.map((log) => (
                  <tr key={log.id} className="hover:bg-zinc-900/50 transition-colors">
                    ...
                    <td className="p-4 text-zinc-400 max-w-xs truncate flex items-center gap-2">
                      <Bot size={14} className="text-[#D4AF37]" /> {log.reply || <span className="text-zinc-700 italic">Sem resposta</span>}
                    </td>
                  </tr>
                ))
              )}
