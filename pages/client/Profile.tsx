...
export const Profile: React.FC = () => {
  ...
  // Função para mascarar CPF (ex: 123.***.***-00)
      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="space-y-6 animate-in slide-in-from-bottom-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6 flex flex-col items-center">
            ...
            <p className="text-zinc-500 text-sm mb-6">{customerData?.status === 'ACTIVE' ? 'Cliente Ativo' : 'Cliente'}</p>

            <div className="w-full space-y-4">
              <InfoRow icon={User} label="CPF" value={customerData?.cpf ? maskCPF(customerData.cpf) : '---'} />

              <div className="bg-black border border-zinc-800 rounded-xl p-4 flex flex-col items-center">
                <ScoreGauge score={customerData?.internal_score || 500} />
              </div>
              ...
              {customerData?.referral_code && (
                <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 border border-purple-700/50 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-purple-300 font-bold text-sm uppercase">Indique e Ganhe</span>
                  </div>
                  <p className="text-zinc-400 text-xs mb-3">Compartilhe seu código e ganhe bônus quando seus amigos contratarem!</p>
                  <div className="flex items-center gap-2">
                    <div className="flex-1 bg-black rounded-lg p-3 text-center">
                      <span className="text-2xl font-mono font-bold text-white tracking-widest">{customerData.referral_code}</span>
                    </div>
                    <button
                      onClick={() => {
